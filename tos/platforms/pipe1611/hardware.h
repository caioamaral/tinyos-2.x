...
TOSH_ASSIGN_PIN(RADIO_SFD, 1, 3); 	//GPIO4
TOSH_ASSIGN_PIN(RADIO_GIO0, 1, 0); 	//GPIO0
TOSH_ASSIGN_PIN(RADIO_FIFO, 1, 5); 	//GPIO1
TOSH_ASSIGN_PIN(RADIO_GIO1, 1, 5); 	//GPIO1
TOSH_ASSIGN_PIN(RADIO_CCA, 1, 4); 	//GPIO3

TOSH_ASSIGN_PIN(CC_FIFOP, 1, 6); 	//GPIO2
TOSH_ASSIGN_PIN(CC_FIFO, 1, 5); 	//GPIO1
TOSH_ASSIGN_PIN(CC_SFD, 1, 3);		//GPIO4
