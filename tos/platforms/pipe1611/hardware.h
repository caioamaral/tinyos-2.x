...
//TOSH_ASSIGN_PIN(CC_SFD, 4, 1); // INPUT ON MOTEPLATFORMC P4DIR
...
// ADC
TOSH_ASSIGN_PIN(ADC0, 6, 2);
TOSH_ASSIGN_PIN(ADC1, 6, 3);
TOSH_ASSIGN_PIN(ADC2, 6, 4);
TOSH_ASSIGN_PIN(ADC3, 6, 5);


// GIO pins
TOSH_ASSIGN_PIN(GIO0, 4, 2);
TOSH_ASSIGN_PIN(GIO1, 4, 3);
TOSH_ASSIGN_PIN(GIO2, 4, 4);
TOSH_ASSIGN_PIN(GIO3, 4, 5);
